...
const NavBar = () => {
  ...
  return (
    <header className='relative xl:max-w-[1140px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px] w-full h-full py-[32px] flex lg:items-center justify-between gap-[24px]'>
      <DesktopNav
